...
<html lang="pt-BR">
    <head>
        ...
        <link rel="canonical" href="https://fccsi.salesianoitajai.g12.br/blog">
...
<body>
    ...
    <h1 class="center">Blog FCCSI</h1>
    <p class="center">Não há muito para ver aqui (ainda). Volte outra hora.</p>
    <div id="disqus_thread"></div>

    <script>
        var disqus_config = function () {
        this.page.url = 'https://fccsi.salesianoitajai.g12.br/blog/index.html'; // Wordpress dynamic variable: '<?php echo get_permalink(); ?>'
